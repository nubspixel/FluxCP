...
class Flux {
	...
	{
		throw new Exception("The function 'getItemType' is now deprecated!");
		/*
		$key  = "ItemTypes.$id";
	...
	public static function getEquipLocationColumnNames() {
		$data = Flux::config('EquipLocationCombinations')->toArray();
	 ...
	 * @access public
	 */
	public static function getEquipLocationCombination($cols)
	{
		$id = implode('|', $cols);
